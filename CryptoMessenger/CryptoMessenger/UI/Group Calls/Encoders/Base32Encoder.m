...
{
	return [Base32Encoder dataFromBase32String: base32String];
}

+ (NSString *)base32StringWithData:(NSData*)data
{
	return [Base32Encoder base32StringFromData: data];
}
...
+ (NSString *)base32StringWithString:(NSString *)string
{
	...
	return [Base32Encoder base32StringFromData: utf8encoding];
}

+ (NSString *)stringFromBase32String:(NSString *)base32String
{
	NSData *utf8encoding = [Base32Encoder dataFromBase32String: base32String];
